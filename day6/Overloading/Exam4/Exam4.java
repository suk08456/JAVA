package day6.Overloading.Exam4;
...
class 저장소 {
    ...
    public static void 저장(int 값) {
//        this.num1 = num1;
        System.out.println(값);
    }

    public static void 저장(String 값) {
//        this.hi = hi;
        System.out.println(값);
    }
//    void 저장(){
...
//        a사과 = new 사과();
//    }
    public static void 저장(double 값){
        System.out.println(값);
    }
    public static void 저장(boolean 값){
        System.out.println(값);
    }
    public static void 저장(char 값){
        System.out.println(값);
    }
}
//class 사람{
